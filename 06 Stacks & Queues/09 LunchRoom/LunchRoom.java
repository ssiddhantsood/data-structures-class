...
public class LunchRoom
{
   ...
   public static int fcustomers = 0;
   public static int ftotalMinutes = 0;
   public static int flongestQueue = 0;
   
   public static int scustomers = 0;
   public static int stotalMinutes = 0;
   public static int slongestQueue = 0;
   
   public static int jcustomers = 0;
   public static int jtotalMinutes = 0;
   public static int jlongestQueue = 0;
   
   public static int xcustomers = 0;
   public static int xtotalMinutes = 0;
   public static int xlongestQueue = 0;
  ...
  // public static PrintWriter outfile = null; //file to show the priority queue
   ...
   {
      PriorityQueue<Customer> customersq = new PriorityQueue<Customer>();
      double ran;
      ...
      for (int i= 0; i<TIME; i++){
         ...
         ran = rand.nextDouble();
            if (ran <= CHANCE_OF_CUSTOMER)
            {
               ...
               customersq.add(new Customer(i,y, r));
            ...
            displayTimeAndQueue(v.getOrder(),customersq);
            }
            else{
            displayTimeAndQueue(0, customersq);
            ...
            if (v != null)
            {
               ...
               if (v.getOrder() == 0)
               {
                 ...
                 {          
                  customersq.remove();
                  ftotalMinutes = ftotalMinutes + i - w.getTime();
                 
                  if (customersq.size() > flongestQueue)
                     flongestQueue = customersq.size();   
                 ...
                 {          
                  customersq.remove();
                  stotalMinutes = stotalMinutes + i - w.getTime();
                 
                  if (customersq.size() > slongestQueue )
                     slongestQueue = customersq.size();   
                 ...
                 {          
                  customersq.remove();
                  jtotalMinutes = jtotalMinutes + i - w.getTime();
                 
                  if (customersq.size() > jlongestQueue )
                     jlongestQueue = customersq.size();   
                 ...
                 {          
                  customersq.remove();
                  xtotalMinutes = xtotalMinutes + i - w.getTime();
                 
                  if (customersq.size() > xlongestQueue )
                     xlongestQueue = customersq.size();   
      ...
      System.out.println("Senior\t\t" + xcustomers + "\t\t\t\t" + xlongestQueue + "\t\t\t\t" + xtotalMinutes/xcustomers);
      System.out.println("Juniors\t\t" + jcustomers + "\t\t\t\t" + jlongestQueue + "\t\t\t\t" + jtotalMinutes/jcustomers);
      System.out.println("Sophmores\t" + scustomers + "\t\t\t\t" + slongestQueue + "\t\t\t\t" + stotalMinutes/scustomers);
      System.out.println("Freshman\t\t" + fcustomers + "\t\t\t\t" + flongestQueue + "\t\t\t\t" + ftotalMinutes/fcustomers);
   }
    ...
    ***********************************/
    ...
    public Customer(int x, int y, int z)
    {
       this.arrivedAt = x;
       this.person = z;
       this.order = y;
