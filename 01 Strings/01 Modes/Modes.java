...
public class Modes
{
   ...
   */
   public static int[] calculateModes(int[] tally) {
        ...
        for (int i = 0; i < tally.length; i++) {
             if (tally[i] == max) {
                for (int f = 0; f<modesArray.length; f++){
                    if (modesArray[f] ==0){
                    modesArray[f] = i;
                    count = count + 1;
                    break;
             ...
             else if ( tally[i] > 0 && tally[i] < max) {
                
            }
            }
          finalArray = new int[count];
         for (int i = 0; i < count; i++){
         finalArray[i] = modesArray[i];
